...
public class Puzzle4_Post : MonoBehaviour
{
    public GameObject puzzle_4, myJoyStick, king, puzzle_station, map, gameOver;
    ...
    public void OnProceedInput()
    {
        ...
        Phase3Data.post_puzzle_Data[attempts + 8] = "Puzzle_4_attempt_" + attempts.ToString() + ": " + attemptData + "    Time taken: " + attemptTime.ToString() + " seconds.";
    }
